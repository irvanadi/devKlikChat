...
public interface APIPackage {
    ...
    @Headers("Accept: application/json")
    @Multipart
    @POST("method/company/update")
    Call<RequestCompany> updateCompany(@Header("Authorization") String Authorization,
                                       @Part MultipartBody.Part cs_image,
                                       @Part MultipartBody.Part info_image,
    ...
    @Headers("Accept: application/json")
    @Multipart
    @POST("method/user/settings")
    Call<ResponseSuccess> updateSettings(@Header("Authorization") String Authorization,
